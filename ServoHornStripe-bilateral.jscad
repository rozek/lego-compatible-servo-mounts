...
const StripeLength = 80.0 + StripeWidth  // ready for a Brachiograph pen plotter
...
/**** add holes to the stripe ****/
  ...
  let leftCross  = translate([ 0,0,Thickness-ServoHornThickness ], Cross)
  let rightCross = translate([ 0,StripeLength-StripeWidth,Thickness-ServoHornThickness ], Cross)

  return subtract(Stripe, leftCross,rightCross)
}
